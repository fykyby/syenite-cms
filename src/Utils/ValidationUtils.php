    ...
    public static function init()
    {
        if (! isset(self::$validator)) {
            self::$validator = new Validator([
                ...
                'required_unless' => 'Value is required unless :field is :value',
                'required_with' => 'Value is required when :fields is present',
                'required_without' => 'Value is required when :fields is not present',
                'required_with_all' => 'Value is required when all of :fields are present',
                'required_without_all' => 'Value is required when none of :fields are present',
                'uploaded_file' => 'Value must be a valid uploaded file of size :min to :max and extension :extensions',
                ...
                'alpha_dash' => 'Value may only contain letters, numbers, dashes, and underscores',
