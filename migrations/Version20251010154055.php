 ...
 */
final class Version20251010154055 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE settings ADD COLUMN current_layout VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE settings ADD COLUMN current_layout_data CLOB NOT NULL');
    }
